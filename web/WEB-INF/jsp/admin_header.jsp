...
<nav style="position:fixed;z-index: 999;width: 100%;background-color: #25c6fc" class="navbar navbar-default"
    ...
    <div class="container-fluid">
        <div class="navbar-header" style="margin-left: 8%;margin-right: 1%">
            <a class="navbar-brand" href="admin_main" style="font-family: 华文行楷; font-size: 250%; color: white">图书管理系统</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-left">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="admin_books">全部图书</a></li>
                        <li class="divider"></li>
                ...
                <li >
                    <a href="admin_repasswd" style="color: white">
                        密码修改
                    </a>
                </li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li><a href="login" style="color: white">${admin.username}, 已登录</a>
                </li>
